...
public class MessageDetailsActivity extends Activity {
	...
	protected void onCreate(Bundle icicle) {
		...
		Intent it =getIntent();
		String senderName = (String) it.getSerializableExtra(JarvisControlActivity.KEY_INTENT_SENDER);
		...
		ArrayList<String> strList = (ArrayList<String>) it.getSerializableExtra(JarvisControlActivity.KEY_INTENT_RECEIVER_LIST);
		...
		String comActName = (String) it.getSerializableExtra(JarvisControlActivity.KEY_INTENT_COM_ACT);
		comAct.setText(comActName);
		
		
		EditText content = (EditText) this.findViewById(R.id.contentDet);
		String contentName = (String) it.getSerializableExtra(JarvisControlActivity.KEY_INTENT_CONTENT);
