...
class GUIUpdater implements ACLMessageListener {
	...
	private JarvisControlActivity act;	
	private static final Logger myLogger = Logger.getMyLogger(JadeGateway.class.getName());
	
	public GUIUpdater(JarvisControlActivity baseActivity) {
	...
	private class Updater implements Runnable {
		...
		private JarvisControlActivity sendMsgAct;
		private ACLMessage message;
		
		
		public Updater(JarvisControlActivity sm, ACLMessage msg) { 
			sendMsgAct = sm;
			message = msg;
